...
TOKEN = '7894200134:AAG5lcR10UwkRke4rf5oqURJnADqwBt4cFQ'
bot = telebot.TeleBot(TOKEN)

admin_id = '6793064302' #ايديك
...
def start(message):
    ...
    if user_id not in users_start_status:
        ...
        subscribe_button = types.InlineKeyboardButton("اشترك الآن 📢", url='https://t.me/SSUU_R')
        markup.add(subscribe_button)
        bot.send_message(message.chat.id, "يرجى الاشتراك في قناة المطور لاستكمال استخدام البوت.\n\nبعد الاشتراك، أرسل /start مرة أخرى.", reply_markup=markup)
        ...
        bot.send_message(message.chat.id, "مرحبًا بك في بوت رفع ملفات بايثون على استضافة\n\n※ يمكنك رفع حتى 1000 ملف\n※ يتم تشغيل الملفات المرفوعة على سيرفر بايثون\n※ لا ترفع ملفات مشبوهة حتى لا يتم حظرك من البوت\n※ اختر نوع الملف الذي تريد رفعه.", reply_markup=markup)
